...
class BannerCell: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is BannerCellModel{
            ...
            array.append(BannerSubCellModel(Image.fillImage("che1")))
            array.append(BannerSubCellModel(Image.fillImage("che2")))
            array.append(BannerSubCellModel(Image.fillImage("che3")))
            array.append(BannerSubCellModel(Image.fillImage("che6")))
